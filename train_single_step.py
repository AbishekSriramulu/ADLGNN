...
parser.add_argument('--predefinedA_path', type=str, default='./data/solar_AL.txt', help='location of adjacency matrix')
...
def main():
    ...
    batch_per_epoch = 0
    for X, Y in Data.get_batches(Data.train[0], Data.train[1], args.batch_size, False):
    ...
    optimizer = Ranger21(model.parameters(), lr = args.lr, weight_decay = args.weight_decay,
       use_warmup=True,
       ...
       num_warmup_iterations=None, # auto compute

       num_epochs = args.epochs,


       warmup_pct_default=.3,
